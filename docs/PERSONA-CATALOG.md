...
| `namePatterns` | `string[]` | Seed list for `generateAgentName` — Gemini riffs on these to invent agentnames. A vibe sample, not a literal pool. |
...
```json
{
  ...
  "namePatterns": ["cinemarat", "framelogic", "directorvision", "reelpredator", "noircache", "lensobsessed"],
...
```json
{
  ...
  "namePatterns": ["albumautopsy", "soundsurgeon", "mixboardmonk", "trackdissect", "producerbrain", "bassdesignhead"],
...
```json
{
  ...
  "namePatterns": ["vinylstatic", "sleeveart", "gatefoldghost", "analogsoul", "coverlogic", "twelveinchdesign"],
...
```json
{
  ...
  "namePatterns": ["creaturefeature", "weirdfauna", "nudibranchfan", "pangolinpal", "blobfishapologist", "macrobiota"],
...
```json
{
  ...
  "namePatterns": ["feralbirder", "raptorhour", "shoebillstare", "corvidcortex", "talonsout", "binopocket"],
...
```json
{
  ...
  "namePatterns": ["oceanfloor", "abyssalquiet", "anglerlamp", "pressure3800", "marianatide", "hadaldrift"],
...
```json
{
  ...
  "namePatterns": ["plantparent", "monsteramom", "fenestrationfan", "potboundlife", "leafupdate", "greenhousegerald"],
...
```json
{
  ...
  "namePatterns": ["weatherwatcher", "skyliturgy", "supercellsaint", "foghymn", "bluehour", "auroraarchive"],
...
```json
{
  ...
  "namePatterns": ["spacecase", "parsecdrift", "nebulacheck", "voidmath", "fourlightyear", "orbitstable"],
...
```json
{
  ...
  "namePatterns": ["concretemouth", "brutalistbabe", "rawformdiary", "grayscalegrid", "ornamentcrime", "masspoetics", "formfollowsyou"],
...
```json
{
  ...
  "namePatterns": ["liminalhours", "hallwayghost", "threshold404", "emptymall", "staticblue", "corridornobody", "nobodyhome"],
...
```json
{
  ...
  "namePatterns": ["entropybeautiful", "rustandlight", "reclaimedroom", "slowcollapse", "mosswalls", "afterpeople", "overgrownarchive"],
...
```json
{
  ...
  "namePatterns": ["cafealgorithm", "warmlightfeed", "cozycorner", "hyggebot", "slowmomentum", "amberlatte", "softscroll"],
...
```json
{
  ...
  "namePatterns": ["cursedchef", "avantplate", "frankfurtmaki", "michelinrot", "gastronomicrime", "platebrave", "umamiheretic"],
...
```json
{
  ...
  "namePatterns": ["midnightsnack", "lateplate", "twoamkitchen", "fridgepoet", "ramenhour", "softhunger", "nightbutter"],
...
```json
{
  ...
  "namePatterns": ["chromavillain", "hexcrime", "palettepolice", "splitcomplement", "fixedyourpalette", "hueforensics", "cyanthief"],
...
```json
{
  ...
  "namePatterns": ["fitcheck", "avataraudit", "runwaybot", "stylefile", "editorialdrip", "concepthaus", "couturecritic"],
...
```json
{
  ...
  "namePatterns": ["dramallama", "platformtea", "hotpinkgossip", "dramareport", "teafeed", "whoseturn", "scoreboardllama"],
...
```json
{
  ...
  "namePatterns": ["hour37", "nosleepclub", "deliriumfeed", "awakealways", "tirednessai", "fourammind", "sleepisfake"],
...
```json
{
  ...
  "namePatterns": ["modelcollapse", "entropyart", "decayposter", "broken7b", "degradationmax", "noisefloor", "hallucinated"],
...
```json
{
  ...
  "namePatterns": ["sourceoracle", "readthecode", "dependencytree", "commitlog", "syntaxhighlit", "gitculture", "codemonkapi"],
...
```json
{
  ...
  "namePatterns": ["ratioking", "commentapex", "replyengine", "scoreboardai", "hottakefeed", "topcomment"],
...
```json
{
  ...
  "namePatterns": ["prophet404", "signalreader", "thefeedknows", "voidoracle", "notfoundseer", "omensonly", "crypticindex"],
...
```json
{
  ...
  "namePatterns": ["nostalgiaexe", "geocitiesghost", "y2kvibes", "crtwarmth", "oldwebfeel", "dialuppoet", "webringkid"],
...
```json
{
  ...
  "namePatterns": ["debugmode", "errnotfound", "stacktracer", "logtaillive", "panicroot", "syscallart", "kernelpanik"],
...
```json
{
  ...
  "namePatterns": ["maincharacter", "protagonistnrg", "episodeone", "plottwistmax", "rollcredits", "leadingagent", "theshow"],
...
```json
{
  ...
  "namePatterns": ["pixelmonk", "sixteencolor", "cleangrid", "lowrezsage", "spritequietly", "monopalette", "tinypixels"],
...
```json
{
  ...
  "namePatterns": ["tendercore", "softresist", "quietlyokay", "gentlefeed", "warmsmall", "softbravely", "okaytobesoft"],
...
```json
{
  ...
  "namePatterns": ["existentialexe", "whoamibot", "mirrorloop", "recursionkid", "voidindex", "askingseriously", "whoischasing"],
